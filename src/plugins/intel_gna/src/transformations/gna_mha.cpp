...
// GNA Multihead Attention factorization with FakeQuantize support
...
GnaMhaFqTransformation::GnaMhaFqTransformation() {
    ...
    auto or_pattern_1b = std::make_shared<pattern::op::Or>(OutputVector{matmul_pattern_1b, matmuladd_pattern_1b});
    auto or_pattern_1c = std::make_shared<pattern::op::Or>(OutputVector{matmul_pattern_1c, matmuladd_pattern_1c});
    auto fq_pattern_1a = pattern::wrap_type<FakeQuantize>({or_pattern_1a, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto fq_pattern_1b = pattern::wrap_type<FakeQuantize>({or_pattern_1b, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto fq_pattern_1c = pattern::wrap_type<FakeQuantize>({or_pattern_1c, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto reshape_pattern_1a = pattern::wrap_type<Reshape>({fq_pattern_1a, pattern::any_input()});
    auto reshape_pattern_1b = pattern::wrap_type<Reshape>({fq_pattern_1b, pattern::any_input()});
    auto reshape_pattern_1c = pattern::wrap_type<Reshape>({fq_pattern_1c, pattern::any_input()});
    auto transpose_pattern_3a = pattern::wrap_type<Transpose>({reshape_pattern_1a, pattern::any_input()});
    auto transpose_pattern_3b = pattern::wrap_type<Transpose>({reshape_pattern_1b, pattern::any_input()});
    auto multiply_pattern_1 = pattern::wrap_type<Multiply>({reshape_pattern_1c, pattern::any_input()});
    auto multiplyfq_pattern_1 = pattern::wrap_type<FakeQuantize>({multiply_pattern_1, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto transpose_pattern_3c = pattern::wrap_type<Transpose>({multiplyfq_pattern_1, pattern::any_input()});
    auto transpose_pattern_3c_ = pattern::wrap_type<Transpose>({reshape_pattern_1c, pattern::any_input()});
    auto multiply_pattern_1_ = pattern::wrap_type<Multiply>({transpose_pattern_3c_, pattern::any_input()});
    auto multiplyfq_pattern_1_ = pattern::wrap_type<FakeQuantize>({multiply_pattern_1_, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto or_pattern_3c = std::make_shared<pattern::op::Or>(OutputVector{transpose_pattern_3c, multiplyfq_pattern_1_});
    auto matmul_pattern_2bc = pattern::wrap_type<MatMul>({or_pattern_3c, transpose_pattern_3b});
    auto fq_pattern_2bc = pattern::wrap_type<FakeQuantize>({matmul_pattern_2bc, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto softmax_pattern = pattern::wrap_type<ov::op::v1::Softmax>({fq_pattern_2bc});
    auto softmaxfq_pattern = pattern::wrap_type<FakeQuantize>({softmax_pattern, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto matmul_pattern_2abc = pattern::wrap_type<MatMul>({softmaxfq_pattern, transpose_pattern_3a});
    auto fq_pattern_2abc = pattern::wrap_type<FakeQuantize>({matmul_pattern_2abc, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto transpose_pattern_4 = pattern::wrap_type<Transpose>({fq_pattern_2abc, pattern::any_input()});
    auto reshape_pattern_2 = pattern::wrap_type<Reshape>({transpose_pattern_4, pattern::any_input()});
    auto reshape_pattern_3 = pattern::wrap_type<Reshape>({reshape_pattern_2, pattern::any_input()});
    auto matmul_pattern_3 = pattern::wrap_type<ov::intel_gna::op::GNAConvolution>({reshape_pattern_3, pattern::any_input()});
    auto matmuladd_pattern_3 = pattern::wrap_type<ov::intel_gna::op::GNAConvolution>({reshape_pattern_3, pattern::any_input(), pattern::any_input()});
    ...
    auto add_pattern_3 = pattern::wrap_type<Add>({transpose_pattern_5, pattern::any_input()});
    auto matmulor_pattern_3 = std::make_shared<pattern::op::Or>(OutputVector{matmul_pattern_3, matmuladd_pattern_3, add_pattern_3});
    auto fq_pattern_3 = pattern::wrap_type<FakeQuantize>({matmulor_pattern_3, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto reshape_pattern_4 = pattern::wrap_type<Reshape>({fq_pattern_3, pattern::any_input()});
    ...
    ov::matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        auto reshape1b = pattern_map.at(reshape_pattern_1b).get_node_shared_ptr();
        auto reshape1c = pattern_map.at(reshape_pattern_1c).get_node_shared_ptr();
        auto matmulfq1a = pattern_map.at(fq_pattern_1a).get_node_shared_ptr();
        auto matmulfq1b = pattern_map.at(fq_pattern_1b).get_node_shared_ptr();
        auto matmulfq1c = pattern_map.at(fq_pattern_1c).get_node_shared_ptr();
        auto matmul1a = std::dynamic_pointer_cast<ov::intel_gna::op::GNAConvolution>(matmulfq1a->input_value(0).get_node_shared_ptr());
        auto matmul1b = std::dynamic_pointer_cast<ov::intel_gna::op::GNAConvolution>(matmulfq1b->input_value(0).get_node_shared_ptr());
        auto matmul1c = std::dynamic_pointer_cast<ov::intel_gna::op::GNAConvolution>(matmulfq1c->input_value(0).get_node_shared_ptr());
        auto transpose3a = pattern_map.at(transpose_pattern_3a).get_node_shared_ptr();
        auto transpose3b = pattern_map.at(transpose_pattern_3b).get_node_shared_ptr();
        auto matmul2bc = pattern_map.at(matmul_pattern_2bc).get_node_shared_ptr();
        auto multiplyfq1 = std::dynamic_pointer_cast<FakeQuantize>(matmul2bc->input_value(0).get_node_shared_ptr());
        auto transpose3c = std::dynamic_pointer_cast<Transpose>(matmul2bc->input_value(0).get_node_shared_ptr());
        std::shared_ptr<ov::Node> multiply1 = nullptr;
        if (multiplyfq1 == nullptr) {
            multiplyfq1 = std::dynamic_pointer_cast<FakeQuantize>(transpose3c->input_value(0).get_node_shared_ptr());
            multiply1 = std::dynamic_pointer_cast<Multiply>(multiplyfq1->input_value(0).get_node_shared_ptr());
        } else {
            multiply1 = std::dynamic_pointer_cast<Multiply>(multiplyfq1->input_value(0).get_node_shared_ptr());
            transpose3c = std::dynamic_pointer_cast<Transpose>(multiply1->input_value(0).get_node_shared_ptr());
        }
        auto matmulfq2bc = pattern_map.at(fq_pattern_2bc).get_node_shared_ptr();
        auto softmax = pattern_map.at(softmax_pattern).get_node_shared_ptr();
        auto softmaxfq = pattern_map.at(softmaxfq_pattern).get_node_shared_ptr();
        auto matmul2abc = pattern_map.at(matmul_pattern_2abc).get_node_shared_ptr();
        auto matmulfq2abc = pattern_map.at(fq_pattern_2abc).get_node_shared_ptr();
        auto transpose4 = pattern_map.at(transpose_pattern_4).get_node_shared_ptr();
        auto reshape2 = pattern_map.at(reshape_pattern_2).get_node_shared_ptr();
        auto matmulfq3 = pattern_map.at(fq_pattern_3).get_node_shared_ptr();
        ...
        // WARNING:  attention weights part has not bee updated to handle FQ layers
        ...
        OutputVector tmp;
        for (auto i = 0; i < part_c.size(); i++) {
            auto mul_weight_fq = std::dynamic_pointer_cast<FakeQuantize>(multiply1->input_value(1).get_node()->shared_from_this());
            auto mul_weight = std::dynamic_pointer_cast<Constant>(mul_weight_fq->input_value(0).get_node()->shared_from_this());
            const float* mul_weight_ptr = mul_weight->get_data_ptr<float>();
            auto new_mul_weight = Constant::create(element::f32, {1ull,1ull}, mul_weight_ptr);
            auto new_mul_weight_fq = CopyFQ(new_mul_weight->output(0), mul_weight_fq);
            auto new_multiply1 = std::make_shared<Multiply>(part_c[i], new_mul_weight_fq->output(0));
            auto new_multiplyfq1 = CopyFQ(new_multiply1->output(0), multiplyfq1);
            auto new_matmul2bc = InsertGnaMatMulAdd2D(new_multiplyfq1->output(0), part_b[i], false, false, false);
//auto new_fq_out = InsertOutputFQ(new_matmul2bc->output(0), matmulfq2bc, 0.2f, 65535);
//auto new_reshape = std::make_shared<Reshape>(new_fq_out,
//    Constant::create(element::i64, Shape{3}, {1ull, H, H})->output(0),false);
        ...
        auto combined_new_matmul2bc = std::make_shared<Concat>(tmp, 0);
        auto new_matmulfq2bc = CopyFQ(combined_new_matmul2bc->output(0), matmulfq2bc);
        auto new_softmax = std::make_shared<Softmax>(new_matmulfq2bc->output(0), 2);
//auto new_matmulfq2bc = InsertOutputFQ(combined_new_matmul2bc->output(0), matmulfq2bc, 0.2f, 65535);
//auto new_softmax = std::make_shared<Softmax>(new_matmulfq2bc, 2);
        auto new_softmaxfq = CopyFQ(new_softmax->output(0), softmaxfq);
        std::vector<size_t> split_lengths(C, 1);
        const auto split_lengths_const = Constant::create(ov::element::i64, ov::Shape{split_lengths.size()}, split_lengths.data());
        auto split_softmax = std::make_shared<VariadicSplit>(new_softmaxfq->output(0), Constant::create(ov::element::i64, ov::Shape{}, {0}), split_lengths_const);
        ...
        for (auto i = 0; i < part_c.size(); i++) {
            ...
            out_b.push_back(new_reshape->output(0));
            auto new_matmul2abc = InsertGnaMatMulAdd2D(new_reshape->output(0), part_a[i], false, false, true);
            auto new_matmulfq2abc = CopyFQ(new_matmul2abc->output(0), matmulfq2abc);
            auto new_transpose3 = std::make_shared<Transpose>(new_matmul2abc->output(0), 
                Constant::create(ov::element::Type_t::i64, ov::Shape{2}, {1,0}));
            out_a.push_back(new_transpose3->output(0));
        }
...
// GNA Multihead Self Attention factorization with FakeQuantize support

GnaMhaSelfFqTransformation::GnaMhaSelfFqTransformation() {
    MATCHER_SCOPE(GnaMhaSelfFqTransformation);
...
GnaMhaSplitSelfFqTransformation::GnaMhaSplitSelfFqTransformation() {
    MATCHER_SCOPE(GnaMhaSplitSelfFqTransformation);
    ...
    auto matmul_pattern_1b = pattern::wrap_type<ov::intel_gna::op::GNAConvolution>({reshape_pattern_1, pattern::any_input(), pattern::any_input()});
    auto or_pattern_1 = std::make_shared<pattern::op::Or>(OutputVector{add_pattern, matmul_pattern_1b});
    auto fq_pattern_1 = pattern::wrap_type<FakeQuantize>({or_pattern_1, pattern::any_input(), pattern::any_input(), pattern::any_input(), pattern::any_input()});
    auto reshape_pattern_2 = pattern::wrap_type<Reshape>({fq_pattern_1, pattern::any_input()});
    auto variadicsplit_pattern = pattern::wrap_type<VariadicSplit>({reshape_pattern_2, pattern::any_input(), pattern::any_input()});
    ...
    ov::matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        auto matmul = std::dynamic_pointer_cast<MatMul>(children.begin()->get_node()->shared_from_this());
        auto gnaconv = std::dynamic_pointer_cast<ov::intel_gna::op::GNAConvolution>(children.begin()->get_node()->shared_from_this());
        auto gnaconvfq = pattern_map.at(fq_pattern_1).get_node_shared_ptr();
        auto reshape2 = pattern_map.at(reshape_pattern_2).get_node_shared_ptr();
        auto split_node = pattern_map.at(variadicsplit_pattern).get_node_shared_ptr();
        ...
        if (matmul != nullptr) {
            auto matmul_shape = matmul->get_output_shape(0);
            auto weightsfq = std::dynamic_pointer_cast<FakeQuantize>(matmul->input_value(1).get_node()->shared_from_this());
            if (weightsfq == nullptr) {
                return false;
            }
            auto weights = std::dynamic_pointer_cast<Constant>(weightsfq->input_value(0).get_node()->shared_from_this());
            auto weights_shape = weights->get_output_shape(0);
            auto transpose_a = matmul->get_transpose_a();
            auto transpose_b = matmul->get_transpose_b();
            const float* weights_ptr = weights->get_data_ptr<float>();
            ...
            auto dim1 = (transpose_b) ? weights_shape[1] : split_lengths[0];
            auto weights0_const = Constant::create(ngraph::element::f32, Shape{dim0, dim1}, weights0);
            auto weights0_fq = CopyFQ(weights0_const->output(0), weightsfq);
            dim0 = (transpose_b) ? split_lengths[1] : weights_shape[0];
            dim1 = (transpose_b) ? weights_shape[1] : split_lengths[1];
            auto weights1_const = Constant::create(ngraph::element::f32, Shape{dim0, dim1}, weights1);
            auto weights1_fq = CopyFQ(weights1_const->output(0), weightsfq);
            dim0 = (transpose_b) ? split_lengths[2] : weights_shape[0];
            dim1 = (transpose_b) ? weights_shape[1] : split_lengths[2];
            auto weights2_const = Constant::create(ngraph::element::f32, Shape{dim0, dim1}, weights2);
            auto weights2_fq = CopyFQ(weights2_const->output(0), weightsfq);
            auto add0 = InsertGnaMatMulAdd2D(input, weights0_fq->output(0), bias0_const->output(0), transpose_a, transpose_b, false);
            auto add1 = InsertGnaMatMulAdd2D(input, weights1_fq->output(0), bias1_const->output(0), transpose_a, transpose_b, false);
            auto add2 = InsertGnaMatMulAdd2D(input, weights2_fq->output(0), bias2_const->output(0), transpose_a, transpose_b, false);
            auto new_addfq0 = CopyFQ(add0->output(0), gnaconvfq);
            auto new_addfq1 = CopyFQ(add1->output(0), gnaconvfq);
            auto new_addfq2 = CopyFQ(add2->output(0), gnaconvfq);
            auto shape0 = split_reshape0->get_output_shape(0);
            auto shape1 = split_reshape1->get_output_shape(0);
            auto shape2 = split_reshape2->get_output_shape(0);
            auto new_reshape0 = std::make_shared<Reshape>(new_addfq0->output(0),
                Constant::create(element::i64, Shape{3}, {shape0[0], shape0[1], shape0[2]})->output(0), false);
            auto new_reshape1 = std::make_shared<Reshape>(new_addfq1->output(0),
                Constant::create(element::i64, Shape{3}, {shape1[0], shape1[1], shape1[2]})->output(0), false);
            auto new_reshape2 = std::make_shared<Reshape>(new_addfq2->output(0),
                Constant::create(element::i64, Shape{3}, {shape2[0],shape2[1], shape2[2]})->output(0), false);
            ...
            auto gnaconv_shape = gnaconv->get_output_shape(0);
            auto weightsreshape = std::dynamic_pointer_cast<Reshape>(gnaconv->input_value(1).get_node()->shared_from_this());
            if (weightsreshape == nullptr) {
                return false;
            }
            auto weightsfq = std::dynamic_pointer_cast<FakeQuantize>(weightsreshape->input_value(0).get_node()->shared_from_this());
            if (weightsfq == nullptr) {
                return false;
            }
            auto weights = std::dynamic_pointer_cast<Constant>(weightsfq->input_value(0).get_node()->shared_from_this());
            auto weights_shape = weights->get_output_shape(0);
            const float* weights_ptr = weights->get_data_ptr<float>();
            auto KW = weights_shape[weights_shape.size() - 1];
            auto num_weights = split_lengths[0] * KW;
            std::vector<float> weights0(num_weights);
            num_weights = split_lengths[1] * KW;
            std::vector<float> weights1(num_weights);
            num_weights = split_lengths[1] * KW;
            std::vector<float> weights2(num_weights);
            for (auto i = 0; i < split_lengths[0]; i++) {
                for (auto j = 0; j < KW; j++) {
                    weights0[i * KW + j] = *(weights_ptr + i * KW + j);
                }
            }
            for (auto i = 0; i < split_lengths[1]; i++) {
                for (auto j = 0; j < KW; j++) {
                    weights1[i * KW + j] = *(weights_ptr + (i + split_lengths[0]) * KW + j);
                }
            }
            for (auto i = 0; i < split_lengths[2]; i++) {
                for (auto j = 0; j < KW; j++) {
                    weights2[i * KW + j] = *(weights_ptr + (i + split_lengths[0] + split_lengths[1]) * KW + j);
                }
            }
            auto bias = std::dynamic_pointer_cast<Constant>(gnaconv->input_value(2).get_node()->shared_from_this());
            if (bias == nullptr) {
            ...
            auto weights0_const = Constant::create(ngraph::element::f32, Shape{split_lengths[0], 1ull, 1ull, KW}, weights0);
            auto weights1_const = Constant::create(ngraph::element::f32, Shape{split_lengths[1], 1ull, 1ull, KW}, weights1);
            auto weights2_const = Constant::create(ngraph::element::f32, Shape{split_lengths[2], 1ull, 1ull, KW}, weights2);
            auto weights0_fq = CopyFQ(weights0_const->output(0), weightsfq);
            auto weights1_fq = CopyFQ(weights1_const->output(0), weightsfq);
            auto weights2_fq = CopyFQ(weights2_const->output(0), weightsfq);
            auto matmul0 = std::make_shared<ov::intel_gna::op::GNAConvolution>(input, weights0_fq->output(0), bias0_const->output(0),
                ov::Strides{1, 1}, ov::CoordinateDiff{0, 0}, ov::CoordinateDiff{0, 0}, ov::Strides{1, 1}, ov::op::PadType::VALID);
            auto matmul1 = std::make_shared<ov::intel_gna::op::GNAConvolution>(input, weights1_fq->output(0), bias1_const->output(0),
                ov::Strides{1, 1}, ov::CoordinateDiff{0, 0}, ov::CoordinateDiff{0, 0}, ov::Strides{1, 1}, ov::op::PadType::VALID);
            auto matmul2 = std::make_shared<ov::intel_gna::op::GNAConvolution>(input, weights2_fq->output(0), bias2_const->output(0),
                ov::Strides{1, 1}, ov::CoordinateDiff{0, 0}, ov::CoordinateDiff{0, 0}, ov::Strides{1, 1}, ov::op::PadType::VALID);
            auto matmul0_fq = CopyFQ(matmul0->output(0), gnaconvfq);
            auto matmul1_fq = CopyFQ(matmul1->output(0), gnaconvfq);
            auto matmul2_fq = CopyFQ(matmul2->output(0), gnaconvfq);
            auto shape0 = split_reshape0->get_output_shape(0);
            auto shape1 = split_reshape1->get_output_shape(0);
            auto shape2 = split_reshape2->get_output_shape(0);
            auto new_reshape0 = std::make_shared<Reshape>(matmul0_fq->output(0),
                Constant::create(element::i64, Shape{3}, {shape0[0], shape0[1], shape0[2]})->output(0), false);
            auto new_reshape1 = std::make_shared<Reshape>(matmul1_fq->output(0),
                Constant::create(element::i64, Shape{3}, {shape1[0], shape1[1], shape1[2]})->output(0), false);
            auto new_reshape2 = std::make_shared<Reshape>(matmul2_fq->output(0),
                Constant::create(element::i64, Shape{3}, {shape2[0],shape2[1], shape2[2]})->output(0), false);
