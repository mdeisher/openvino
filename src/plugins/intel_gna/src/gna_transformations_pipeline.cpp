...
#include "transformations/gna_dilatconv1d.hpp"
...
#include "transformations/gna_norm.hpp"
...
void TransformationsPipeline::apply(const std::shared_ptr<ov::Model>& model,
    ...
    bool has_convolution = ov::op::util::has_op_with_type<ngraph::opset7::Convolution>(model) ||
...
has_convolution = true;
    //////////////////////////////// GNA PRE-PROCESSING ////////////////////////////
    manager.register_pass<ov::pass::Serialize>("before_pre_proc.xml", "before_pre_proc.bin");
    ...
    manager.register_pass<ngraph::pass::GnaDilatConvolution1dDecomposition>();
    manager.register_pass<ngraph::pass::GnaPadConvolutionDecomposition>();
    manager.register_pass<ov::pass::Serialize>("after_pre_proc.xml", "after_pre_proc.bin");
    /////////////////////////////////////////////////////////////////////////////////
    ...
    //manager.register_pass<ov::pass::GnaOldStackedLstmDecomposition>();
    ...
    //manager.register_pass<ov::pass::Serialize>("before_convmatmul.xml", "before_convmatmul.bin");
    // if (!has_convolution) {
    ...
    manager.register_pass<ov::intel_gna::pass::GnaRewriteNormTransformation>();
    manager.register_pass<ov::pass::Serialize>("after_rewritenorm.xml", "after_rewritenorm.bin");
    ...
    manager.register_pass<ov::pass::Serialize>("before_softmax.xml", "before_softmax.bin");
    ...
    manager.register_pass<ov::pass::Serialize>("after_softmax.xml", "after_softmax.bin");
    ...
    has_slice = true;
    manager.register_pass<ov::pass::Serialize>("before_concat.xml", "before_concat.bin");
